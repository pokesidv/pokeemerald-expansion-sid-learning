...
#define INFINITE_REPEL_FLAG         0x24 // assign this to an unused flag if you want the select button inside the select menu to toggle between infinite repel ON and OFF