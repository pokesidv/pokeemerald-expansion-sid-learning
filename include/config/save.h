...
#define ENABLE_MULTIPLE_REGISTERED_ITEMS    TRUE // Enable multiple registered items feature. always enable ENABLE_HEAT_SELECT_MENU as well from config/heat_menus.h if you set this to TRUE
