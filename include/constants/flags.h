...
#define FLAG_SID_REPEL          0x24 // renamed: set the flag to repel pokemon (see INFINITE_REPEL_FLAG in heat_menus.h for details)
...
#define NUM_BADGES                                   (1 + FLAG_BADGE09_GET - FLAG_BADGE01_GET)

// Towns and Cities
#define FLAG_VISITED_LITTLEROOT_TOWN                (SYSTEM_FLAGS + 0x10)
#define FLAG_VISITED_OLDALE_TOWN                    (SYSTEM_FLAGS + 0x11)
#define FLAG_VISITED_DEWFORD_TOWN                   (SYSTEM_FLAGS + 0x12)
...
#define FLAG_OW_FLAG_SUPPRESS_NAME_BOX              (SYSTEM_FLAGS + 0x24) // renamed: see overworld.h configs
