...
enum {
    ...
    HEAL_LOCATION_CHITIN_CRAG_DALE,
    HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE_2F_2,
    HEAL_LOCATION_ARDOR_PROVINCE_ROUTE1,
    HEAL_LOCATION_ARDOR_PROVINCE_ROUTE2A,
    HEAL_LOCATION_IRONWILL_MONASTERY,
    HEAL_LOCATION_KINDLEHEARTH_FORGE,
    HEAL_LOCATION_CINDER_PEAK_BASTION,
    HEAL_LOCATION_DRIFTBROOK_HAVEN,
    HEAL_LOCATION_FROSTVEIL_BURRROW,
    HEAL_LOCATION_GLADEWARD_CRADLE,
    HEAL_LOCATION_GRIMFEN_THICKET,
    HEAL_LOCATION_LORETIDE_SHELL,
    HEAL_LOCATION_STILLMIST_COVE,
    HEAL_LOCATION_THORNWOOD_CROSS,
    HEAL_LOCATION_VOLTLOFT_CANOPY,
    NUM_HEAL_LOCATIONS
};
