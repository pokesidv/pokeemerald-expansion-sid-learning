...
#define METATILE_Fallarbor_ClimbableRockWallLeft     0x2C4
#define METATILE_Fallarbor_ClimbableRockWallRight    0x2DC
#define METATILE_Fallarbor_ClimbableRockWallUp       0x2BA
