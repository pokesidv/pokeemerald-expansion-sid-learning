...
#define POKEVIAL_SKIP_CUTSCENE  TRUE // When this FALSE is changed to TRUE, when using the Pokevial, the item will cut to the party screen and use the HealPlayerParty special instead.
