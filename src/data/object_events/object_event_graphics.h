...
const u32 gFieldEffectObjectPic_LavaClimbSpray[] = INCBIN_U32("graphics/field_effects/pics/lava_climb_spray.4bpp");
...
const u16 gFieldEffectPal_Lava[] = INCBIN_U16("graphics/field_effects/palettes/lava.gbapal");
