...
const struct Tileset gTilesetDummy4 =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTilesDummy4,
    .palettes = gTilesetPalettesDummy4,
    .metatiles = gMetatilesDummy4,
    .metatileAttributes = gMetatileAttributesDummy4,
    .callback = NULL,
};
