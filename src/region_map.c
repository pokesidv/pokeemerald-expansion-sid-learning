...
static const u32 sRegionMapBg_GfxLZ[] = INCBIN_U32("graphics/pokenav/region_map/map.4bpp.smol");
...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_KINDLEHEARTH_FORGE] = {MAP_GROUP(MAP_KINDLEHEARTH_FORGE), MAP_NUM(MAP_KINDLEHEARTH_FORGE), HEAL_LOCATION_KINDLEHEARTH_FORGE},
    [MAPSEC_CHITINCRAG_DALE] = {MAP_GROUP(MAP_CHITIN_CRAG_DALE), MAP_NUM(MAP_CHITIN_CRAG_DALE), HEAL_LOCATION_CHITIN_CRAG_DALE},
    [MAPSEC_IRONWILL_MONASTERY] = {MAP_GROUP(MAP_IRONWILL_MONASTERY), MAP_NUM(MAP_IRONWILL_MONASTERY), HEAL_LOCATION_IRONWILL_MONASTERY},
    [MAPSEC_CINDERPEAK_BASTION] = {MAP_GROUP(MAP_CINDER_PEAK_BASTION), MAP_NUM(MAP_CINDER_PEAK_BASTION), HEAL_LOCATION_CINDER_PEAK_BASTION},
    [MAPSEC_DRIFTBROOK_HAVEN] = {MAP_GROUP(MAP_DRIFTBROOK_HAVEN), MAP_NUM(MAP_DRIFTBROOK_HAVEN), HEAL_LOCATION_DRIFTBROOK_HAVEN},
    [MAPSEC_FROSTVEIL_BURROW] = {MAP_GROUP(MAP_FROSTVEIL_BURRROW), MAP_NUM(MAP_FROSTVEIL_BURRROW), HEAL_LOCATION_FROSTVEIL_BURRROW},
    [MAPSEC_STILLMIST_COVE] = {MAP_GROUP(MAP_STILLMIST_COVE), MAP_NUM(MAP_STILLMIST_COVE), HEAL_LOCATION_STILLMIST_COVE},
    [MAPSEC_LORETIDE_SHELL] = {MAP_GROUP(MAP_LORETIDE_SHELL), MAP_NUM(MAP_LORETIDE_SHELL), HEAL_LOCATION_LORETIDE_SHELL},
    [MAPSEC_THORNWOOD_CROSS] = {MAP_GROUP(MAP_THORNWOOD_CROSS), MAP_NUM(MAP_THORNWOOD_CROSS), HEAL_LOCATION_THORNWOOD_CROSS},
    [MAPSEC_GRIMFEN_THICKET] = {MAP_GROUP(MAP_GRIMFEN_THICKET), MAP_NUM(MAP_GRIMFEN_THICKET), HEAL_LOCATION_GRIMFEN_THICKET},
    [MAPSEC_VOLTLOFT_CANOPY] = {MAP_GROUP(MAP_VOLTLOFT_CANOPY), MAP_NUM(MAP_GRIMFEN_THICKET), HEAL_LOCATION_GRIMFEN_THICKET},
    [MAPSEC_GLADEWARD_CRADLE] = {MAP_GROUP(MAP_GLADEWARD_CRADLE), MAP_NUM(MAP_GRIMFEN_THICKET), HEAL_LOCATION_GRIMFEN_THICKET},
};
...
bool8 LoadRegionMapGfx(void)
{
    ...
    case 2:
        if (!FreeTempTileDataBuffersIfPossible())
            LoadPalette(sRegionMapBg_Pal, BG_PLTT_ID(6), 4 * PLTT_SIZE_4BPP);
        break;
    case 3:
...
void BlendRegionMap(u16 color, u32 coeff)
{
    ...
    CpuCopy16(&gPlttBufferFaded[BG_PLTT_ID(6)], &gPlttBufferUnfaded[BG_PLTT_ID(6)], 4 * PLTT_SIZE_4BPP);
}
...
static u8 GetMapsecType(mapsec_u16_t mapSecId)
{
    switch (mapSecId)
    {
    case MAPSEC_THORNWOOD_CROSS:
        return MAPSECTYPE_CITY_CANFLY;
    case MAPSEC_GRIMFEN_THICKET:
        return MAPSECTYPE_CITY_CANFLY;
    case MAPSEC_VOLTLOFT_CANOPY:
        return MAPSECTYPE_CITY_CANFLY;
    case MAPSEC_GLADEWARD_CRADLE:
        return MAPSECTYPE_CITY_CANFLY;
    case MAPSEC_KINDLEHEARTH_FORGE:
        return MAPSECTYPE_CITY_CANFLY;
    case MAPSEC_CHITINCRAG_DALE:
        return MAPSECTYPE_CITY_CANFLY;
    case MAPSEC_IRONWILL_MONASTERY:
        return MAPSECTYPE_CITY_CANFLY;
    case MAPSEC_CINDERPEAK_BASTION:
        return MAPSECTYPE_CITY_CANFLY;
    case MAPSEC_DRIFTBROOK_HAVEN:
        return MAPSECTYPE_CITY_CANFLY;
    case MAPSEC_FROSTVEIL_BURROW:
        return MAPSECTYPE_CITY_CANFLY;
    case MAPSEC_STILLMIST_COVE:
        return MAPSECTYPE_CITY_CANFLY;
    case MAPSEC_LORETIDE_SHELL:
        return MAPSECTYPE_CITY_CANFLY;
    case MAPSEC_NONE:
