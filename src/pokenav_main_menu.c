...
static const u8 *const sHelpBarTexts[HELPBAR_COUNT] =
{
    ...
    [HELPBAR_MAP_ZOOMED_OUT_CANFLY] = COMPOUND_STRING("{A_BUTTON}ZOOM {B_BUTTON}CANCEL {R_BUTTON}GO"),
    [HELPBAR_MAP_ZOOMED_IN_CANFLY]  = COMPOUND_STRING("{A_BUTTON}FULL {B_BUTTON}CANCEL {R_BUTTON}GO"),
...
static const struct CompressedSpriteSheet sMenuLeftHeaderSpriteSheets[] =
{
    ...
    [POKENAV_GFX_ACCESS_PC_MENU] = {
        .data = gPokenavLeftHeaderMainMenu_Gfx,
        .size = 0x20,
        .tag = 3
    },
    [POKENAV_GFX_ACCESS_DEXNAV_MENU] = {
        .data = gPokenavLeftHeaderMainMenu_Gfx,
        .size = 0x20,
        .tag = 3
    },
